class Company < ApplicationRecord
    attr_accessor :fully_diluted_shares, :outstanding_options, :shareholder_fully_diluted, :fully_diluted_total, :fully_diluted_subtotal_percentage, :conversion_results
